...
public class TakeDrinkAction : ASimpleAction
{
    ...
    public TakeDrinkAction(IAgent agent, VendingMachineManager vendingMachine, StateMachine sm) : base(agent) 
    {
    ...
    public override void Update()
    {
        ...
        else
        {
            ...
            if (_time <= 0)
            {
                _stateMachine.State = new CheckEmployeeNecessitiesState(_stateMachine, agent, new ArtistWorkState(_stateMachine, agent));
                finished = true;
            }
        }
    }
